...
-(void) showWithBlock:(BlockDialogOpt) block buttonNames:(nonnull NSArray<NSString*>*)buttonNames{
    ...
    [PYPopupTools setMoveable:YES targetView:showView];
    [PYPopupTools setMoveable:NO targetView:self];
    [PYPopupTools setShowView:showView targetView:self];
    [PYPopupTools showWithTargetView:self];
...
+(void) setMessage:(nonnull NSString*) message blockStyle:(void (^) (NSAttributedString* attArg)) blockStyle targetView:(nonnull UIView*) targetView{
